...
string text = "Свежий, характерный запах лесных грибов, влажной земли, мха. " +
    ...
    "Синергия: Iso E Super — добавляет прозрачности и амбровой теплоты Evernyl (мох) — усиливает лесную и мшистую грань Floralozone и Helional — создают атмосферу утреннего леса Muscenone или Cosmone — усиливают skin scent-эффект Ноты пачули, ветивера, кедра Применение: В малых дозировках (0.01–0.1%) придаёт композиции ощущение реалистичной глубины, природной ауры, свежести утреннего леса. Особенно популярен в нишевой парфюмерии и ароматерапевтических композициях.";
string wrongComponent = "acetanisole";
string rightComponent = "iso e super";
